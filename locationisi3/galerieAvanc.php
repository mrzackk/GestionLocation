...
<body class="no-main-slider">
  ...
  <section>
    ...
    <div class="container">
      ...
      //  echo $_SESSION["sea"];
           // echo $resultat;
                  $req="SELECT `idV`,`image`,`couleur`,`categorie`,`coutParJour`,`marque`,md.num FROM `voiture` v inner join marque m on v.idmarque=m.idmarque inner join modele md on v.idM=md.idM inner join agence a on v.idA=a.idA WHERE 1=1";

           // if (isset($_SESSION['prixddd'])) $req.=" AND coutParJour LIKE '%".$_SESSION['prixddd']."%'";
           //  if (isset($_SESSION['prixfff'])) $req.=" AND coutParJour LIKE '%".$_SESSION['prixfff']."%'";
                   if (isset($_SESSION['markkk']) && $_SESSION['markkk']) $req.=" AND marque ='".$_SESSION["markkk"]."'";
             if (isset($_SESSION['cityyy']) && $_SESSION['cityyy']) $req.=" AND villeAgence ='".$_SESSION["cityyy"]."'";
               if (isset($_SESSION['prixddd']) && isset($_SESSION["prixfff"]) && $_SESSION['prixddd'] && $_SESSION['prixfff']) $req.=" AND coutParJour BETWEEN '".$_SESSION['prixddd']."' AND '".$_SESSION['prixfff']."'";
    //echo $req;
             //if (isset($_SESSION['prixddd']) && isset($_SESSION["prixfff"])) $req.=" AND coutParJour BETWEEN ".$_SESSION['prixddd']." AND ".$_SESSION['prixfff'];
             // echo $_SESSION['markkk'];
            ...
            ?>
            <?php
         //    echo $_SESSION['prixfff'];
                //echo $_SESSION['prixddd'];
           //echo $_SESSION['cityyy'];
           //echo $_SESSION['markkk'];?>
